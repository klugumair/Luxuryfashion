        ...
        >
          <div className="p-4">
            ...
            >
              ...
              {/* Google Account Switch Button (only for Google users) */}
              {user.provider === 'google' && (
                <motion.button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50 transition-all duration-200 group"
                  whileHover={{ x: 2, scale: 1.005 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <motion.div
                    className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center text-blue-600 group-hover:from-blue-200 group-hover:to-cyan-200"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.3 }}
                  >
